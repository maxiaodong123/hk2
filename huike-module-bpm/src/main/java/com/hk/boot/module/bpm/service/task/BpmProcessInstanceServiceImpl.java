package com.hk.boot.module.bpm.service.task;
...
import com.hk.boot.framework.common.util.object.PageUtils;
import com.hk.boot.framework.datapermission.core.annotation.DataPermission;
import com.hk.boot.module.bpm.api.task.dto.BpmProcessInstanceCreateReqDTO;
import com.hk.boot.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import com.hk.boot.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import com.hk.boot.module.bpm.controller.admin.task.vo.instance.*;
import com.hk.boot.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import com.hk.boot.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import com.hk.boot.module.bpm.convert.task.BpmProcessInstanceConvert;
import com.hk.boot.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import com.hk.boot.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import com.hk.boot.module.bpm.enums.ErrorCodeConstants;
import com.hk.boot.module.bpm.enums.definition.BpmModelTypeEnum;
import com.hk.boot.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import com.hk.boot.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import com.hk.boot.module.bpm.enums.task.BpmReasonEnum;
import com.hk.boot.module.bpm.enums.task.BpmTaskStatusEnum;
import com.hk.boot.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import com.hk.boot.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import com.hk.boot.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import com.hk.boot.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import com.hk.boot.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import com.hk.boot.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import com.hk.boot.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import com.hk.boot.module.bpm.framework.flowable.core.util.FlowableUtils;
import com.hk.boot.module.bpm.framework.flowable.core.util.SimpleModelUtils;
import com.hk.boot.module.bpm.service.definition.BpmProcessDefinitionService;
import com.hk.boot.module.bpm.service.message.BpmMessageService;
import com.hk.boot.module.system.api.dept.DeptApi;
import com.hk.boot.module.system.api.dept.dto.DeptRespDTO;
...
import static com.hk.boot.framework.common.util.collection.CollectionUtils.*;
import static com.hk.boot.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static com.hk.boot.module.bpm.enums.ErrorCodeConstants.*;
import static com.hk.boot.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static com.hk.boot.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;
...
public class BpmProcessInstanceServiceImpl implements BpmProcessInstanceService {
    ...
    @DataPermission(enable = false) // 关闭数据权限，避免查询不到用户数据。相关案例：https://gitee.com/zhijiantianya/huike-cloud/issues/ID1UYA
