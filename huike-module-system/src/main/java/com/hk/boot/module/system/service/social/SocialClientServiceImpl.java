package com.hk.boot.module.system.service.social;
...
import com.hk.boot.framework.common.util.cache.CacheUtils;
import com.hk.boot.framework.common.util.http.HttpUtils;
import com.hk.boot.framework.common.util.object.BeanUtils;
import com.hk.boot.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.hk.boot.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.hk.boot.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import com.hk.boot.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.hk.boot.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.hk.boot.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.hk.boot.module.system.dal.dataobject.social.SocialClientDO;
import com.hk.boot.module.system.dal.mysql.social.SocialClientMapper;
import com.hk.boot.module.system.dal.redis.RedisKeyConstants;
import com.hk.boot.module.system.enums.social.SocialTypeEnum;
import com.hk.boot.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.hk.boot.framework.common.util.collection.MapUtils.findAndThen;
import static com.hk.boot.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.hk.boot.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
import static com.hk.boot.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${huike.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${huike.wxa-subscribe-message.miniprogram-state:formal}")
