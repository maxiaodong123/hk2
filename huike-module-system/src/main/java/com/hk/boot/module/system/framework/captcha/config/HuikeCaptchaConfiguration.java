package com.hk.boot.module.system.framework.captcha.config;

import com.hk.boot.module.system.framework.captcha.core.RedisCaptchaServiceImpl;
...
public class HuikeCaptchaConfiguration {
