package com.hk.boot.module.system.service.user;
...
import com.hk.boot.framework.common.util.collection.ArrayUtils;
...
import com.hk.boot.module.infra.api.file.FileApi;
...
import com.hk.boot.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import com.hk.boot.module.system.controller.admin.user.vo.user.UserImportRespVO;
import com.hk.boot.module.system.controller.admin.user.vo.user.UserPageReqVO;
import com.hk.boot.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import com.hk.boot.module.system.dal.dataobject.dept.DeptDO;
import com.hk.boot.module.system.dal.dataobject.dept.PostDO;
import com.hk.boot.module.system.dal.dataobject.dept.UserPostDO;
import com.hk.boot.module.system.dal.dataobject.tenant.TenantDO;
import com.hk.boot.module.system.dal.dataobject.user.AdminUserDO;
import com.hk.boot.module.system.dal.mysql.dept.UserPostMapper;
import com.hk.boot.module.system.dal.mysql.user.AdminUserMapper;
import com.hk.boot.module.system.enums.common.SexEnum;
import com.hk.boot.module.system.service.dept.DeptService;
...
import com.hk.boot.module.system.service.permission.PermissionService;
...
import static com.hk.boot.framework.common.util.collection.SetUtils.asSet;
...
import static com.hk.boot.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("huikeyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("huikeyuanma");
        ...
        assertEquals("huikeyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("huikeyuanma"))).thenReturn("java");
