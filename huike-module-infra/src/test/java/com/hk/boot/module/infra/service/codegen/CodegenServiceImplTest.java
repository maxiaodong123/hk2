package com.hk.boot.module.infra.service.codegen;

import cn.hutool.core.collection.ListUtil;
import cn.hutool.core.map.MapUtil;
import com.hk.boot.framework.common.pojo.PageResult;
import com.hk.boot.framework.test.core.ut.BaseDbUnitTest;
import com.hk.boot.module.infra.controller.admin.codegen.vo.CodegenCreateListReqVO;
import com.hk.boot.module.infra.controller.admin.codegen.vo.CodegenUpdateReqVO;
import com.hk.boot.module.infra.controller.admin.codegen.vo.column.CodegenColumnSaveReqVO;
import com.hk.boot.module.infra.controller.admin.codegen.vo.table.CodegenTablePageReqVO;
import com.hk.boot.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import com.hk.boot.module.infra.dal.dataobject.codegen.CodegenColumnDO;
import com.hk.boot.module.infra.dal.dataobject.codegen.CodegenTableDO;
import com.hk.boot.module.infra.dal.dataobject.db.DataSourceConfigDO;
import com.hk.boot.module.infra.dal.mysql.codegen.CodegenColumnMapper;
import com.hk.boot.module.infra.dal.mysql.codegen.CodegenTableMapper;
import com.hk.boot.module.infra.enums.codegen.CodegenFrontTypeEnum;
import com.hk.boot.module.infra.enums.codegen.CodegenSceneEnum;
import com.hk.boot.module.infra.enums.codegen.CodegenTemplateTypeEnum;
import com.hk.boot.module.infra.framework.codegen.config.CodegenProperties;
import com.hk.boot.module.infra.service.codegen.inner.CodegenBuilder;
import com.hk.boot.module.infra.service.codegen.inner.CodegenEngine;
import com.hk.boot.module.infra.service.db.DataSourceConfigService;
import com.hk.boot.module.infra.service.db.DatabaseTableService;
...
import static com.hk.boot.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.hk.boot.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static com.hk.boot.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static com.hk.boot.framework.test.core.util.AssertUtils.assertPojoEquals;
import static com.hk.boot.framework.test.core.util.AssertUtils.assertServiceException;
import static com.hk.boot.framework.test.core.util.RandomUtils.*;
import static com.hk.boot.module.infra.enums.ErrorCodeConstants.*;
