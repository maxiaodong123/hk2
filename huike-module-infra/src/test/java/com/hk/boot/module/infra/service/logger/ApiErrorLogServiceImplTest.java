package com.hk.boot.module.infra.service.logger;
...
import com.hk.boot.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.hk.boot.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.hk.boot.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.hk.boot.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.hk.boot.framework.common.util.date.LocalDateTimeUtils.*;
...
import static com.hk.boot.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.hk.boot.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("huike-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("huike-test");
