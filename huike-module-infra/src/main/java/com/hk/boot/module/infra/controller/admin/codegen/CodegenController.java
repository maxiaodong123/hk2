package com.hk.boot.module.infra.controller.admin.codegen;
...
import com.hk.boot.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import com.hk.boot.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import com.hk.boot.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import com.hk.boot.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import com.hk.boot.module.infra.convert.codegen.CodegenConvert;
...
import com.hk.boot.module.infra.service.codegen.CodegenService;
...
import static com.hk.boot.framework.security.core.util.SecurityFrameworkUtils.getLoginUserNickname;
import static com.hk.boot.module.infra.framework.file.core.utils.FileTypeUtils.writeAttachment;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "huike"),
