package com.hk.boot.framework.tracer.config;

import com.hk.boot.framework.common.enums.WebFilterOrderEnum;
import com.hk.boot.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "huike.tracer", value = "enable", matchIfMissing = true)
public class HuikeTracerAutoConfiguration {
