package com.hk.boot.framework.web.config;
...
import com.hk.boot.framework.web.core.filter.CacheRequestBodyFilter;
import com.hk.boot.framework.web.core.filter.DemoFilter;
import com.hk.boot.framework.web.core.handler.GlobalExceptionHandler;
import com.hk.boot.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class HuikeWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "huike.demo", havingValue = "true")
