package com.hk.boot.framework.jackson.config;

import com.hk.boot.framework.common.util.json.JsonUtils;
import com.hk.boot.framework.common.util.json.databind.NumberSerializer;
import com.hk.boot.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import com.hk.boot.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class HuikeJacksonAutoConfiguration {
