package com.hk.boot.framework.mybatis.config;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.StrUtil;
import com.hk.boot.framework.common.util.json.JsonUtils;
import com.hk.boot.framework.mybatis.core.handler.DefaultDBFieldHandler;
...
@MapperScan(value = "${huike.info.base-package}", annotationClass = Mapper.class,
        lazyInitialization = "${mybatis.lazy-initialization:false}") // Mapper 懒加载，目前仅用于单元测试
public class HuikeMybatisAutoConfiguration {
