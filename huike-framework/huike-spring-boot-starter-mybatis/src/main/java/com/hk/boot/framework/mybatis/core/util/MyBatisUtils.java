package com.hk.boot.framework.mybatis.core.util;
...
import com.hk.boot.framework.common.pojo.SortingField;
import com.hk.boot.framework.mybatis.core.enums.DbTypeEnum;
...
public class MyBatisUtils {
    ...
    public static <T> Page<T> buildPage(PageParam pageParam, Collection<SortingField> sortingFields) {
        ...
        page.setOptimizeJoinOfCountSql(false); // 关联 issue：https://gitee.com/zhijiantianya/huike-cloud/issues/ID2QLL
        // 排序字段
