package com.hk.boot.framework.mq.redis.config;

import cn.hutool.core.map.MapUtil;
import cn.hutool.core.util.StrUtil;
import cn.hutool.system.SystemUtil;
import com.hk.boot.framework.common.enums.DocumentEnum;
import com.hk.boot.framework.mq.redis.core.RedisMQTemplate;
import com.hk.boot.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import com.hk.boot.framework.mq.redis.core.job.RedisStreamMessageCleanupJob;
import com.hk.boot.framework.mq.redis.core.pubsub.AbstractRedisChannelMessageListener;
import com.hk.boot.framework.mq.redis.core.stream.AbstractRedisStreamMessageListener;
...
public class HuikeRedisMQConsumerAutoConfiguration {
