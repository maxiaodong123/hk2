package com.hk.boot.framework.tenant.config;

import com.hk.boot.framework.common.biz.system.tenant.TenantCommonApi;
...
import com.hk.boot.framework.tenant.core.service.TenantFrameworkService;
import com.hk.boot.framework.tenant.core.service.TenantFrameworkServiceImpl;
import com.hk.boot.framework.tenant.core.web.TenantContextWebFilter;
import com.hk.boot.framework.tenant.core.web.TenantVisitContextInterceptor;
import com.hk.boot.framework.web.config.WebProperties;
import com.hk.boot.framework.web.core.handler.GlobalExceptionHandler;
...
@AutoConfiguration
@ConditionalOnProperty(prefix = "huike.tenant", value = "enable", matchIfMissing = true) // 允许使用 huike.tenant.enable=false 禁用多租户
@EnableConfigurationProperties(TenantProperties.class)
public class HuikeTenantAutoConfiguration {
    ...
    public RedisCacheManager tenantRedisCacheManager(RedisTemplate<String, Object> redisTemplate,
                                                     ...
                                                     HuikeCacheProperties huikeCacheProperties,
                                                     TenantProperties tenantProperties) {
        // 创建 RedisCacheWriter 对象
        RedisConnectionFactory connectionFactory = Objects.requireNonNull(redisTemplate.getConnectionFactory());
        RedisCacheWriter cacheWriter = RedisCacheWriter.nonLockingRedisCacheWriter(connectionFactory,
                BatchStrategies.scan(huikeCacheProperties.getRedisScanBatchSize()));
