package com.hk.boot.framework.ratelimiter.config;

import com.hk.boot.framework.ratelimiter.core.aop.RateLimiterAspect;
import com.hk.boot.framework.ratelimiter.core.keyresolver.RateLimiterKeyResolver;
import com.hk.boot.framework.ratelimiter.core.keyresolver.impl.*;
import com.hk.boot.framework.ratelimiter.core.redis.RateLimiterRedisDAO;
...
public class HuikeRateLimiterConfiguration {
