package com.hk.boot.module.crm.controller.admin.product.vo.product;
...
import com.hk.boot.module.crm.enums.DictTypeConstants;
...
public class CrmProductRespVO implements VO {
    ...
    @Trans(type = TransType.SIMPLE, targetClassName = "com.hk.boot.module.system.dal.dataobject.user.AdminUserDO",
