package com.hk.boot.module.crm.controller.admin.customer.vo.customer;

import com.hk.boot.framework.common.validation.InEnum;
import com.hk.boot.framework.common.validation.Mobile;
import com.hk.boot.framework.common.validation.Telephone;
import com.hk.boot.framework.excel.core.annotations.DictFormat;
import com.hk.boot.module.crm.enums.customer.CrmCustomerLevelEnum;
import com.hk.boot.module.crm.framework.operatelog.core.CrmCustomerIndustryParseFunction;
import com.hk.boot.module.crm.framework.operatelog.core.CrmCustomerLevelParseFunction;
import com.hk.boot.module.crm.framework.operatelog.core.CrmCustomerSourceParseFunction;
import com.hk.boot.module.crm.framework.operatelog.core.SysAreaParseFunction;
...
import static com.hk.boot.framework.common.util.date.DateUtils.FORMAT_YEAR_MONTH_DAY_HOUR_MINUTE_SECOND;
import static com.hk.boot.module.crm.enums.DictTypeConstants.CRM_CUSTOMER_INDUSTRY;
